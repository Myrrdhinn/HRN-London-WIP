...
<head>
<meta name="description" content="Save thousands of euros and gain exclusive benefits at our London and Paris HR events.">
	        ...
	        <div id="GoldMobileContent">
                ...
                <div class="CheckList">
                    <ul>
                        ...
                        <a href="#FAQ1"><li><i class="fa fa-check-circle"></i> <span class="MobileListItem">Key Account Manager<i class="fa fa-question-circle"></i></span></li></a>
...
<section id="FAQContainer">
    ...
    <p id="Answer1" class="Answer">Tickets are valid for our 2015 events, HR Tech Europe in London (March 24<sup>th</sup> and 25<sup>th</sup>) and the HR Tech World Congress in Paris (October 27<sup>th</sup> and 28<sup>th</sup>).</p>
    ...
    <p id="Answer3" class="Answer">Your account manager is responsible for ensuring you and your team can make the most of your event experience.</p>
    ...
    <p id="Answer9" class="Answer">The HR Tech World Party is being held in Paris on October 27<sup>th</sup>, shortly after the end of the conference's first day. It's a chance to relax and network with thousands of your colleagues and counterparts in a more informal setting.</p>                        
