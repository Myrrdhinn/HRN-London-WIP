...
<body>
 <!--Main Wrapper-->
	<div class="wrapper">
	  <h1 class="WrapperMainH1">HR Tech Europe - London2015 |<br /> Add New Speaker</h1>
  ...
  $content .='</div>
	...
	<!--Form container-->
	 <div id="container">
	     ...
	     <form id="speakers" name="speakers" method="post" action="controllers/main.php" enctype="multipart/form-data"><br />
  ...
  $content .='<input type="hidden" id="CompanyBio" name="CompanyBio" ><br />
	  ...
	  <fieldset>
	     <legend>Social</legend>
		  <input class="AdminInputField" id="SpeakerTwitter" name="SpeakerTwitter" type="text" placeholder="Twitter" /><br />
		  <input class="AdminInputField" id="SpeakerFacebook" name="SpeakerFacebook" type="text" placeholder="Facebook" /><br />
		  <input class="AdminInputField" id="SpeakerLinkedin" name="SpeakerLinkedin" type="text" placeholder="Linkedin" /><br />
		  <input class="AdminInputField" id="SpeakerFlickr" name="SpeakerFlickr" type="text" placeholder="Flickr" /><br />
		  <input class="AdminInputField" id="SpeakerGoogle" name="SpeakerGoogle" type="text" placeholder="Google+" /><br />
     </fieldset>
	 
	 <fieldset>
	     <legend>Bio</legend>
         <label>Speaker bio important<textarea id="SpeakerBioImp" name="SpeakerBioImp" cols="" rows=""></textarea></label><br />
         <label>Speaker bio<textarea id="SpeakerBio" name="SpeakerBio" cols="" rows=""></textarea></label><br />
     </fieldset>
