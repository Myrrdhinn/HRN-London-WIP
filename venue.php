        ...
        <li> <a onClick="_gaq.push(['_trackEvent', 'Navigation', 'InternalForward', 'Agenda']);" href="agenda" >Agenda</a></li>
          <li id="ExpoMobileGroup">Expo <i class="fa fa-angle-right"></i><i class="fa fa-angle-down"></i></li>
       	  <div id="ExpoMobileGroupContent">
                <li><a onClick="_gaq.push(['_trackEvent', 'Navigation', 'InternalForward', 'MediaPartners']);" href="venue" class="ActiveNavmenuItem">Venue</a></li>
...
center of international trade and finance.</p>
    ...
    <div id="MainContent"> 
      ...
      <nav id="OnsiteNavContainer">
        <ul>
          <li class="OnsiteNavActive"><a onClick="_gaq.push(['_trackEvent', 'ExpoSiteNavigation', 'InternalForward', 'Venue']);" href="venue"><img src="img/logistics/onsitenav-venue.svg" alt="Venue Icon" />
            <div>
              <h4>Venue</h4>
              <h6>Excel London</h6>
            </div>
      ...
      <section id='ExCelDescription'>
       <h2>ExCel London</h2>
       <p>ExCeL London, the exhibition and international convention centre, is the host venue for a variety of events from award winning exhibitions and conferences to international association meetings, product launches, banquets, award ceremonies, sporting events and great days out.<br>
<br>

Situated in a stunning waterfront location, ExCeL London is located in the heart of London's Royal Docks, within easy reach of central London. The venue is part of a 100 acre campus, including 3 onsite DLR stations, easy access to the Jubilee Line and London City Airport, parking for 3,700 cars, six onsite hotels and numerous on-site bars and restaurants.<br>
<br>
<strong>Hr Tech Europe</strong> will take place at the East End of the Excel; we recommend to access the event from the East Entrance - located right next to the Prince Regent station.
</p> 
      </section>
