...
<div class="off-canvas-wrap" data-offcanvas>
  <div class="inner-wrap"> 
      ...
      <ul>
        ...
        <li> <a onClick="_gaq.push(['_trackEvent', 'Navigation', 'InternalForward', 'Agenda']);" href="agenda" >Agenda</a></li>
       	  ...
       	  <div id="ExpoMobileGroupContent">
                ...
                <li><a onClick="_gaq.push(['_trackEvent', 'Navigation', 'InternalForward', 'Sponsors']);" href="hotels" class="ActiveNavmenuItem">Hotels</a></li>
          </div>
    ...
    <div class="ImageHeader">
      <h1>Hotels</h1>
      <p>Special Offers at various hotels around London. Search through our list of hotels to save money.</p>
    </div>
    ...
    <div id="MainContent"> 
      ...
      <nav id="OnsiteNavContainer">
        <ul>
          ...
          <li><a onClick="_gaq.push(['_trackEvent', 'ExpoSiteNavigation', 'InternalForward', 'Logistics']);" href="logistics"><img src="img/logistics/onsitenav-logistics.svg" alt="Logistics Icon" />
            <div>
              <h4>Logistics</h4>
              <h6>How to get there?</h6>
            </div>
            </a></li>
          <li class="OnsiteNavActive"><a onClick="_gaq.push(['_trackEvent', 'ExpoSiteNavigation', 'InternalForward', 'Hotels']);" href=""><img src="img/logistics/onsitenav-hotels.svg" alt="Hotels Icon" />
            <div>
              <h4>Hotels</h4>
      ...
      <!-- END Our Premier Partner --> 
      
    </div>
    <!--END MAIN CONTENT--> 
    
    <!-- LOCATIONS MAIN CONTENT -->
    <div id="LocationsMainContent"> 
      <!-- Canary Wharf -->
      <div class="LocationContainer" id="CanaryWharf">
        ...
        <div class="HotelContainer" id="HiltonCanaryWharf">
          ...
          <div class="HotelDescription">
            <h2>Hilton Canary Wharf</h2>
            <div class="StarContainer"> <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> </div>
            <h2>&pound;279 Single /  &pound;291 Double</h2>
            <h6>VAT & Breakfast included</h6>
            <div class="BookNowButton">Book Now</div>
          </div>
        </div>
        </a> </div>
      ...
      <div class="LocationContainer" id="Stratford">
        ...
        <div class="HotelContainer" id="TheWestbridge">
          ...
          <div class="HotelDescription">
            <h2>The Westbridge</h2>
            <div class="StarContainer"> <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> </div>
             <h2>&pound;139 Single /  &pound;149 Double</h2>
            <h6>VAT & Breakfast included</h6>
            <div class="PromoCode">promo code: HRTECH15</div>
            <p><strong>Important:</strong> please book your room via +44(0)20 3327 4969 or reservations@thewestbidge.com with the promotion code.</p>
          </div>
        </div>
        </a> </div>
      <!-- End Stratford --> 
      ...
      <!--  Tower -->
      <div class="LocationContainer" id="Tower">
        ...
        <div class="HotelContainer" id="ApexCityOfLondon">
          ...
          <div class="HotelDescription">
            <h2>Apex City of London</h2>
            <div class="StarContainer"> <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> </div>
             <h2>&pound;209 (23rd) /  &pound;249 (24th)</h2>
            <h6>VAT included</h6>
            <div class="BookNowButton">Book Now</div>
            </div>
        </div>
        ...
        <div class="HotelContainer" id="GuomanTower">
          ...
          <div class="HotelDescription">
            <h2>Guoman Tower</h2>
            <div class="StarContainer"> <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> </div>
            <h2>&pound;205 Single /  &pound;215 Double</h2>
            <h6>VAT & Breakfast included</h6>
            <div class="PromoCode">promo code: HRTW230315</div>
            <p><strong>Important:</strong> please book your room via +44 (0)871 376 9036 or tower.allocations@gouman.co.uk with the promotion code.</p>
          </div>
        </div>
        </a> 
        <!-- End Guoman Tower --> 
