...
<link rel="stylesheet" href="cnt/css/navmenu.css" />

<!--	Include Custom CSS Definitions -->
<link rel="stylesheet" href="cnt/css/custom.css" />
<link rel="stylesheet" href="cnt/css/contact.css" />

<!-- Footer -->
<link rel="stylesheet" href="cnt/css/footer.css" />
  ...
  <div class="inner-wrap"> 
    ...
    <nav id="MainNavigationMenu">
      <div id="DesktopMenuContainer"> <a id="HeaderLogoLink" onClick="_gaq.push(['_trackEvent', 'Navigation', 'InternalForward', 'LogoHome']);" href="index"><img id="HRTechSmallLogo" alt="HR Tech Logo" src="img/hrtech-logo-small.png"></a> <a href="index" onClick="_gaq.push(['_trackEvent', 'Navigation', 'InternalForward', 'MainPage']);" >Home</a>
        ...
        <a onClick="_gaq.push(['_trackEvent', 'Navigation', 'InternalForward', 'MainPage']);" class="ActiveNavmenuItem" href="contact">Get in Touch</a> </div>
      ...
      <ul>
        ...
        <li> <a onClick="_gaq.push(['_trackEvent', 'Navigation', 'InternalForward', 'Agenda']);" href="agenda" >Agenda</a></li>
       	  ...
       	  <div id="ExpoMobileGroupContent">
                <li><a onClick="_gaq.push(['_trackEvent', 'Navigation', 'InternalForward', 'MediaPartners']);" href="venue">Venue</a></li>
                <li><a onClick="_gaq.push(['_trackEvent', 'Navigation', 'InternalForward', 'BlogSquad']);" href="logistics">Logistics</a></li>
                <li><a onClick="_gaq.push(['_trackEvent', 'Navigation', 'InternalForward', 'Sponsors']);" href="hotels">Hotels</a></li>
          </div>
        ...
        <li> <a onClick="_gaq.push(['_trackEvent', 'Navigation', 'InternalForward', 'Contact']);" class="ActiveNavmenuItem" href="contact" >Get in Touch</a></li>
      </ul>
    </nav>
    ...
    <!-- Header -->
    <header>
      <div class="ImageHeader" style="background:url(cnt/img/header.jpg);">
        <h1>Get in Touch</h1>
        <p>Reach us directly by phone or email, or leave us a message and we'll get back to you as soon as possible.</p>
      </div>
    ...
    <div id="ContactMembersContainer" class="OswaldText">
      <div class="ContactMember">
        <div id="SteveMic"> <img src="cnt/img/MathewS.jpg" alt="Steve George picture"></div>
        <p class="ContactPosition" id="SteveTitle">SPEAKERS</p>
        <p>Steve George</p>
        <p class="ContactEmail">+36 1 201 1469 /213</p>
      </div>
      <div class="ContactMember">
        <div id="PeterFile"><img src="cnt/img/RussellP.jpg" alt="Peter Russell picture"></div>
        <p class="ContactPosition" id="PeterTitle">RESEARCH &amp; ANALYSTS</p>
        <p>Peter Russell</p>
        <p class="ContactEmail">+33 648 923 260</p>
      </div>
      <div class="ContactMember">
        <div id="ViktoriaCog"> <img src="cnt/img/McCannV.jpg" alt="Victoria McCann picture"></div>
        <p class="ContactPosition" id="ViktoriaTitle">OPERATIONS</p>
        <p>Viktoria McCann</p>
        <p class="ContactEmail">+36 1 201 1469 /209</p>
      </div>
      <div class="ContactMember">
        <div id="MarcPeople"> <img src="cnt/img/ColemanM.jpg" alt="Marc Coleman picture"></div>
        <p class="ContactPosition" id="MarcTitle">PARTNERS</p>
        <p>Marc Coleman</p>
        <p class="ContactEmail">+36 1 201 1469 /250</p>
      </div>
      <div class="ContactMember">
        <div id="ClaireBadge"> <img src="cnt/img/QuitoC.jpg" alt="Claire Quito picture"></div>
        <p class="ContactPosition" id="ClaireTitle">DELEGATES</p>
        <p>Claire Quito</p>
        <p class="ContactEmail">+36 1 201 1469 /216</p>
      </div>
    </div>
    <!--MAIN CONTENT --> 
    <!-- FORM -->
    <div id="ContactFormSection">
      <div id="ContactTextContainer">
        <div id="ContactAdress">
          <div class="ContactIconContainer"><i class="fa fa-pencil"></i></div>
          <h6 class="ContactText OswaldText">HRN EUROPE<br />
            Millenáris Irodaház<br />
            39. Lövoház utca,<br />
            1024 Budapest, Hungary </h6>
        </div>
        <div id="ContactGen">
          <div class="ContactIconContainer"><i class="fa fa-phone"></i></div>
          <h6 class="ContactText OswaldText">General Inquiries<br />
            +36 1 201 1469<br />
            UK & Ireland Number<br />
            +44 20 34 689 689 </h6>
        </div>
        <div id="ContactMail">
          <div class="ContactIconContainer"><i class="fa fa-envelope"></i></div>
          <h6 class="ContactText OswaldText">hrn@hrneurope.com </h6>
        </div>
      </div>
        ...
        <form action="https://www.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8" method="POST">
          ...
          <div class="row">
            <div class="large-6 columns">
              ...
              <input placeholder="Email Address"  id="email" maxlength="80" name="email" size="20" type="text" />
              <input placeholder="Phone Number"  id="phone" maxlength="40" name="phone" size="20" type="text" />
              <input placeholder="Company"  id="company" maxlength="40" name="company" size="20" type="text" />
                           <select style="display:none;"   id="lead_source" name="lead_source" placeholder="Lead Source"><option selected="selected" value="HRTechLondon2015-GetInTouch">HRTechLondon2015-GetInTouch</option>
                      </select>
            </div>
            <div class="large-6 columns">
     ...
     <div class="captcha" style="text-align:center;">
         ...
         <h6 class="OswaldText text-center" style="color:#fff; margin-bottom:20px;" id="ClickHandleText">Please click the handle or swipe it to the right!</h6>
          <div class="row">
            <div class="large-12 column">
              <input onClick="_gaq.push(['_trackEvent', 'ContactForm', 'FormSubmission', 'InquirySent']);" type="submit" class="ContactSubmitbutton" name="submit" value="Send">
            </div>
          </div>
        </form>
      </div>
