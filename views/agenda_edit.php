...
<body>
    ...
    <div>
    <fieldset>
    <legend>Agenda Edit</legend>
	<label>Agendas<select id="Agenda" name="Agenda">
	<option value="">Select an Agenda</option>';
   $content .= $agend->agenda_list();
   $content .= ' 
    </select></label><br /><br />
   ...
   <label>Abstract<textarea name="Abstract" cols="25" rows="5"></textarea></label><br /><br />
	<label>Speakers <select id="Speakers" name="Speakers[]" multiple>';
