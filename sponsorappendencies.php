...
<meta name="author" content="Developed by: TesseracT - bottyan.tamas@web-developer.hu | Benedek Nagy - trialshock@gmail.com">
<meta charset="utf-8" />
...
<script type="text/javascript">
  $(document).ready(function() {
			if ( (screen.width < 640)  ) { 
    			alert("This website have not yet been optimized to mobile view. Please use a laptop or dekstop computer to visit this page in order to avoid malfunctioning behaviour.");
    		} 
           	});			
</script>
